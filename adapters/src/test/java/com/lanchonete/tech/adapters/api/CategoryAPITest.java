package com.lanchonete.tech.adapters.api;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lanchonete.tech.adapters.ControllerTest;
...
public class CategoryAPITest {
    ...
    public void givenAValidCommand_whenCallUpdateCategory_shouldReturnCategoryId() throws Exception {
        ...
        when(updateCategoryUseCase.execute(any())).thenReturn(UpdateCategoryOutput.from(expectedId));
