...
import com.lanchonete.tech.adapters.E2ETest;
import com.lanchonete.tech.adapters.configuration.Json;
import com.lanchonete.tech.adapters.category.models.CategoryResponse;
import com.lanchonete.tech.adapters.category.models.CreateCategoryRequest;
import com.lanchonete.tech.adapters.category.models.UpdateCategoryRequest;
...
public class CategoryE2ETest {
    ...
    @Container
    public static PostgreSQLContainer<?> POSTGRES_CONTAINER = new PostgreSQLContainer<>("postgres:12")
    ...
    public static void setDatasourceProperties(final DynamicPropertyRegistry registry) {
        registry.add("postgres.port", () -> POSTGRES_CONTAINER.getMappedPort(3306));
    }
