...
public class CategoryTest {
    ...
    public void givenAnInvalidNullName_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        ...
        final var actualException =
                assertThrows(DomainException.class, () -> Category.newCategory(expectedName, expectedDescription, expectedIsActive));
    ...
    public void givenAValidEmptyDescription_whenCallNewCategoryAndValidate_thenInstantiateACategory() {
        ...
        final var actualCategory = assertDoesNotThrow(() -> Category.newCategory(expectedName, expectedDescription, expectedIsActive));
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivated() {
        ...
        final var aCategory = assertDoesNotThrow(() -> Category.newCategory(expectedName, expectedDescription, true));
        ...
        assertDoesNotThrow(() -> aCategory.validate(Notification.create()));
